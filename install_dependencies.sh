...
curl -L https://github.com/OUIsolutions/SilverChain/releases/download/v0.07/CSilverChainApiNoDependenciesIncluded.h -o  dependencies/CSilverChainApiNoDependenciesIncluded.h
